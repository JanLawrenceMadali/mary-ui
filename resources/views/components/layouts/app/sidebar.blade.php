...
<body class="min-h-screen font-sans antialiased bg-base-200">
    ...
    {{-- NAVBAR mobile only --}}
    <x-mary-nav sticky class="lg:hidden !bg-[#1B4298] text-white dark:!bg-red-800">
        <x-slot:brand>
    ...
    <x-mary-main full-width>
        {{-- SIDEBAR --}}
        <x-slot:sidebar drawer="main-drawer" collapsible class="!bg-[#1B4298] lg:bg-inherit text-white dark:!bg-neutral-800">
            ...
            <a href="{{ route('dashboard') }}" class="display-when-collapsed">
                <img src="{{ asset('assets/images/bmi-logo.png') }}" class="h-15" alt="bmi-logo">
            </a>
